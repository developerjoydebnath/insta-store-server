module.exports = {
    devConfig: {
        ...
        CLIENT_ORIGIN:
            'localhost,localhost:3000,localhost:3001,localhost:5000,localhost:8000,localhost:5173,insta-store-server.vercel.app',
        ORIGIN: 'http://localhost,http://localhost:5173,http://localhost:5000,https://insta-store-server.vercel.app/',
    },
};
